...
const pricingPlans = [
  {
    name: "Starter",
    price: "KES 1,000",
    cadence: "1 month free",
    summary: "For farmers testing digital records.",
    limit: "Up to 200 active animals",
    features: ["Unlimited users", "Multiple farm branches", "Role-based permissions", "Detailed financial reports and priority support"],
    cta: "Choose Starter",
  },
  {
    name: "Standard",
  ...
  },
  {
    ...
    limit: "Up to 1000 active animals",
    features: ["Unlimited users", "Multiple farm branches", "Role-based permissions", "Detailed financial reports and priority support"],
    cta: "Choose Business",
  },
  {
    ...
    limit: "Up to 3,000 active animals",
    features: ["Unlimited users", "Multiple farm branches", "Role-based permissions", "Detailed financial reports and priority support"],
